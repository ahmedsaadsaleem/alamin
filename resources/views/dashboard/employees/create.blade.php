                    ...
                    <form method="POST" action="{{route('employees.store')}}">
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <input class="form-control @error('first_name') is-invalid @else {{old('first_name') ? 'is-valid' : '';}} @enderror" type="text" name="first_name" id="first_name" value="{{old('first_name')}}" />
                                @error('first_name')
                            ...
                            <div class="col-sm-6">
                                ...
                                <input class="form-control @error('last_name') is-invalid @else {{old('last_name') ? 'is-valid' : '';}} @enderror" type="text" name="last_name" id="last_name" value="{{old('last_name')}}" />
                                @error('last_name')
                                    <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="col-sm-6">
                                ...
                                <input class="form-control @error('email') is-invalid @else {{old('email') ? 'is-valid' : '';}} @enderror" type="email" name="email" id="email" value="{{old('email')}}" />
                                @error('email')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="col-sm-6">
                                ...
                                <input class="form-control @error('phone_number') is-invalid @else {{old('phone_number') ? 'is-valid' : '';}} @enderror" type="text" name="phone_number" id="phone_number" value="{{old('phone_number')}}" />
                                @error('phone_number')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <input class="form-control @error('hire_date') is-invalid @else {{old('hire_date') ? 'is-valid' : '';}} @enderror" type="date" name="hire_date" id="hire_date" value="{{old('hire_date')}}" />
                                @error('hire_date')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="col-sm-6">
                                ...
                                <input class="form-control @error('job_title') is-invalid @else {{old('job_title') ? 'is-valid' : '';}} @enderror" type="text" name="job_title" id="job_title" value="{{old('job_title')}}" />
                                @error('job_title')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="col-sm-6">
                                ...
                                <select name="department" id="department" class="form-select @error('department') is-invalid @else {{old('department') ? 'is-valid' : '';}} @enderror">
                                    ...
                                    <option value="{{$department->id}}" @selected(old('department') == $department->id)>{{$department->department_name}}</option>
                                    @endforeach
                                </select>                                
                                @error('department')
                                    <div class="invalid-feedback">{{$message}}</div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="manager" id="manager" class="form-select @error('manager') is-invalid @else {{old('manager') ? 'is-valid' : '';}} @enderror">
                                    ...
                                    <option value="{{$manager->id}}" @selected(old('manager') == $manager->id)>{{$manager->first_name.' '.$manager->last_name}}</option>
                                    @endforeach
                                </select>                                
                                @error('manager')
                                    <div class="invalid-feedback">{{$message}}</div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input class="form-control @error('city') is-invalid @else {{old('city') ? 'is-valid' : '';}} @enderror" type="text" name="city" id="city" value="{{old('city')}}" />
                                @error('city')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="col-sm-6">
                                ...
                                <input class="form-control @error('state') is-invalid @else {{old('state') ? 'is-valid' : '';}} @enderror" type="text" name="state" id="state" value="{{old('state')}}" />
                                @error('state')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="col-sm-6">
                                ...
                                <input class="form-control @error('postal_code') is-invalid @else {{old('postal_code') ? 'is-valid' : '';}} @enderror" type="text" name="postal_code" id="postal_code" value="{{old('postal_code')}}" />
                                @error('postal_code')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <select name="country" id="country" class="form-select @error('country') is-invalid @else {{old('country') ? 'is-valid' : '';}} @enderror">
                                    ...
                                    <option value="{{$country->id}}" @selected(old('country') === $country->id)>{{$country->country_ar.' - '.$country->country_en}}</option>
                                    @endforeach
                                </select>
                                @error('country')
                                <div class="invalid-feedback">{{$message}}</div>
