                    ...
                    <form method="POST" action="{{route('groups.update', $group->id)}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-5 col-md-7">
                                <input class="form-control @error('group_name') is-invalid @else {{old('group_name') ? 'is-valid' : '';}} @enderror" type="text" name="group_name" id="group_name" value="{{old('group_name') ?? $group->group_name}}" />
                                @error('group_name')
                            ...
                            <div class="col-lg-5 col-md-7">
                                <div class="row">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="roles[]" id="{{$role->role_name}}" value="{{$role->id}}" @checked($groupRoles->contains('id', '=', $role->id)) />
